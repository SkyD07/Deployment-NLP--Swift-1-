$(document).ready(function(){
  ...
  function generate_message2(msg, type) {
    ...
    if (res_data_prediksi == 'Anger'){
      str += "<div class=\"cm-msg-text3\">";
    }
    else if (res_data_prediksi == 'Happy'){
      str += "<div class=\"cm-msg-text4\">";
    }
    else if (res_data_prediksi == 'Sadness'){
      str += "<div class=\"cm-msg-text5\">";
    }
    else if (res_data_prediksi == 'Love'){
      str += "<div class=\"cm-msg-text6\">";
    }
    else if (res_data_prediksi == 'Fear'){
      str += "<div class=\"cm-msg-text7\">";
    }
    else str += "<div class=\"cm-msg-text2\">";
